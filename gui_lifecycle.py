...
def run_gui_lifecycle(
    ...
    *,
    ...
    if scenario not in {"default", "instruments", "runtime-cancel", "project-gate"}:
...
def main(argv=None) -> int:
    ...
    parser.add_argument(
        "--scenario",
        choices=("default", "instruments", "runtime-cancel", "project-gate"),
        default="default",
        help="可选真实交互场景；project-gate 验证三镜头签名项目门禁",
    )
